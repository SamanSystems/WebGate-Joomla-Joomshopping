...
class pm_zarinpal extends PaymentRoot{
	...
	function showEndForm($pmconfigs, $order){
        ...
        <form id="paymentform" action="<?php echo JURI::base();?>components/com_jshopping/payments/pm_zarinpal/request.php" name = "paymentform" method = "post">
        ...
        <?php echo "در حال انتقال به صفحه پرداخت . لطفا کمی صبر نمایید"; ?>
        <br>
